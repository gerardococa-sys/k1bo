-- ===========================================================
-- Artifex7 — Datos de Demostración para El Salvador
...
INSERT INTO auth.users (
  ...
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0001-000000000001','authenticated','authenticated','cliente1@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Ana María Portillo"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0001-000000000002','authenticated','authenticated','cliente2@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Sandra Beatriz González"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0001-000000000003','authenticated','authenticated','cliente3@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Mario José Moreno"}',false),
  -- PROFESIONALES — Cielo Falso y Divisiones
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000001','authenticated','authenticated','pro01@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Carlos Hernández Ayala"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000002','authenticated','authenticated','pro02@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Roberto Martínez Cruz"}',false),
  -- Paneles WPC y PVC
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000003','authenticated','authenticated','pro03@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Miguel Ángel Torres Mendoza"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000004','authenticated','authenticated','pro04@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"José Luis Ramos Díaz"}',false),
  -- Ventanas PVC
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000005','authenticated','authenticated','pro05@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Eduardo Flores Gutiérrez"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000006','authenticated','authenticated','pro06@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Óscar Pereira Aguilar"}',false),
  -- Albañilería
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000007','authenticated','authenticated','pro07@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Juan Carlos López Rivas"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000008','authenticated','authenticated','pro08@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Ernesto Vásquez Portillo"}',false),
  -- Pintura
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000009','authenticated','authenticated','pro09@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Antonio Mejía Salinas"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000010','authenticated','authenticated','pro10@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Francisco Portillo Chávez"}',false),
  -- Jardinería
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000011','authenticated','authenticated','pro11@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Luis Alberto Morales Pineda"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000012','authenticated','authenticated','pro12@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Rodrigo Sánchez Henríquez"}',false),
  -- Fontanería
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000013','authenticated','authenticated','pro13@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Héctor Molina Escalón"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000014','authenticated','authenticated','pro14@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Óscar Fuentes Barrera"}',false),
  -- Electricidad
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000015','authenticated','authenticated','pro15@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Rafael Zelaya Montes"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000016','authenticated','authenticated','pro16@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Jesús Ramírez Bonilla"}',false),
  -- Estructura Metálica
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000017','authenticated','authenticated','pro17@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Víctor Argueta Mejía"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000018','authenticated','authenticated','pro18@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Marco Antonio Guzmán Peña"}',false),
  -- Pisos
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000019','authenticated','authenticated','pro19@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Alejandro Reyes Castellanos"}',false),
  ('00000000-0000-0000-0000-000000000000','d0000000-0000-0000-0000-000000000020','authenticated','authenticated','pro20@artifex7-demo.com',crypt('Demo1234!',gen_salt('bf')),now(),now(),now(),'','','','{"provider":"email","providers":["email"]}','{"full_name":"Diego Chávez Hernández"}',false)
...
INSERT INTO auth.identities (id, user_id, provider_id, identity_data, provider, last_sign_in_at, created_at, updated_at) VALUES
  ('d0000000-0000-0000-0001-000000000001','d0000000-0000-0000-0001-000000000001','cliente1@artifex7-demo.com','{"sub":"d0000000-0000-0000-0001-000000000001","email":"cliente1@artifex7-demo.com"}','email',now(),now(),now()),
  ('d0000000-0000-0000-