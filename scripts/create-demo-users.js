/**
 * Artifex7 — Script para crear usuarios y datos de demostración
 *
 * Uso:
...
// ─── Clientes demo ─────────────────────────────────────────────────────────────
const DEMO_CLIENTS = [
  { email: 'cliente1@artifex7-demo.com', full_name: 'Ana María Portillo',      phone: '7100-1001' },
  { email: 'cliente2@artifex7-demo.com', full_name: 'Sandra Beatriz González', phone: '7100-1002' },
  { email: 'cliente3@artifex7-demo.com', full_name: 'Mario José Moreno',       phone: '7100-1003' },
]

// ─── Profesionales demo ────────────────────────────────────────────────────────
const DEMO_PROFESSIONALS = [
  {
    email: 'pro01@artifex7-demo.com', full_name: 'Carlos Hernández Ayala', phone: '7123-4567',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Necesito instalar cielo falso de tabla roca en mi sala y comedor.', required_date: '2024-02-10', rating: 5, comment: 'Excelente trabajo en el cielo falso de mi sala. Quedó perfecto, limpio y terminado a tiempo. Lo recomiendo sin dudarlo.', review_date: '2024-02-20' },
      { client: 'cliente2@artifex7-demo.com', description: 'Quiero instalar divisiones de tabla roca para separar mi oficina.', required_date: '2024-03-05', rating: 5, comment: 'Instaló divisiones de tabla roca en mi oficina con acabados muy profesionales. Puntual y ordenado.', review_date: '2024-03-15' },
      { client: 'cliente3@artifex7-demo.com', description: 'Instalar cielo falso en habitación principal.', required_date: '2024-04-01', rating: 4, comment: 'Buen trabajo y precio justo. El cielo falso de mi habitación quedó muy bien, recomendado.', review_date: '2024-04-10' },
    ],
  },
  {
    email: 'pro02@artifex7-demo.com', full_name: 'Roberto Martínez Cruz', phone: '7234-5678',
    ...
    main_category: 'cielo-falso-divisiones',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Cielo falso PVC para baño y cocina.', required_date: '2024-02-15', rating: 5, comment: 'Instaló cielo falso PVC en baño y cocina. Resistente a la humedad y quedó perfecto.', review_date: '2024-02-25' },
      { client: 'cliente2@artifex7-demo.com', description: 'Reparación de cielo falso dañado por humedad.', required_date: '2024-03-10', rating: 4, comment: 'Muy amable y trabajador. Reparó el cielo dañado de manera eficiente y con garantía.', review_date: '2024-03-20' },
      { client: 'cliente3@artifex7-demo.com', description: 'Cielo falso para sala de reuniones.', required_date: '2024-04-05', rating: 4, comment: 'Precio justo y buena calidad. Mi sala de reuniones quedó con un aspecto muy profesional.', review_date: '2024-04-15' },
    ],
  },
  {
    email: 'pro03@artifex7-demo.com', full_name: 'Miguel Ángel Torres Mendoza', phone: '7345-6789',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Revestir paredes de sala con paneles WPC decorativos.', required_date: '2024-02-20', rating: 5, comment: 'Transformó mis paredes con paneles WPC. El resultado es increíble y muy moderno.', review_date: '2024-03-01' },
      { client: 'cliente2@artifex7-demo.com', description: 'Paneles WPC para local comercial.', required_date: '2024-03-15', rating: 5, comment: 'Trabajo limpio, rápido y profesional. Los paneles quedaron perfectos en mi negocio.', review_date: '2024-03-25' },
      { client: 'cliente3@artifex7-demo.com', description: 'Revestimiento de pared exterior con paneles PVC.', required_date: '2024-04-10', rating: 4, comment: 'Materiales de calidad y buena instalación. Mi pared exterior quedó muy bien.', review_date: '2024-04-20' },
    ],
  },
  {
    email: 'pro04@artifex7-demo.com', full_name: 'José Luis Ramos Díaz', phone: '7456-7890',
    ...
    main_category: 'paneles-wpc-pvc',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Paneles decorativos para recepción de oficina.', required_date: '2024-03-01', rating: 5, comment: 'Instaló paneles en mi recepción y quedó elegantísima. Muy recomendado.', review_date: '2024-03-10' },
      { client: 'cliente2@artifex7-demo.com', description: 'Revestimiento WPC para dormitorio principal.', required_date: '2024-03-20', rating: 4, comment: 'Buen profesional, trabajo ordenado y acabado de primera calidad.', review_date: '2024-03-30' },
      { client: 'cliente3@artifex7-demo.com', description: 'Paneles PVC para área de cocina.', required_date: '2024-04-15', rating: 4, comment: 'Precio competitivo y excelente resultado. Definitivamente lo volvería a contratar.', review_date: '2024-04-25' },
    ],
  },
  {
    email: 'pro05@artifex7-demo.com', full_name: 'Eduardo Flores Gutiérrez', phone: '7567-8901',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Cambiar 6 ventanas de aluminio por PVC en mi casa.', required_date: '2024-03-05', rating: 5, comment: 'Mis ventanas nuevas de PVC son perfectas. Reducen mucho el calor y el ruido de la calle.', review_date: '2024-03-15' },
      { client: 'cliente2@artifex7-demo.com', description: 'Ventanas PVC para segundo piso de residencia.', required_date: '2024-03-25', rating: 5, comment: 'Instalación rápida y limpia. Los marcos quedaron bien sellados, sin filtraciones.', review_date: '2024-04-05' },
      { client: 'cliente3@artifex7-demo.com', description: 'Puerta de PVC para entrada principal.', required_date: '2024-04-20', rating: 4, comment: 'Excelente inversión. La diferencia en temperatura dentro de mi casa es muy notable.', review_date: '2024-05-01' },
    ],
  },
  {
    email: 'pro06@artifex7-demo.com', full_name: 'Óscar Pereira Aguilar', phone: '7678-9012',
    ...
    main_category: 'ventanas-pvc',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Ventanas PVC a medida para local comercial.', required_date: '2024-03-10', rating: 5, comment: 'Ventanas a medida, bien instaladas y con garantía incluida. Muy satisfecho.', review_date: '2024-03-20' },
      { client: 'cliente2@artifex7-demo.com', description: 'Reparación de ventana PVC dañada.', required_date: '2024-03-30', rating: 4, comment: 'Profesional y puntual. Mi casa quedó mucho más fresca y silenciosa.', review_date: '2024-04-10' },
      { client: 'cliente3@artifex7-demo.com', description: 'Instalar ventana PVC en habitación nueva.', required_date: '2024-04-25', rating: 4, comment: 'Atendió todas mis dudas y el resultado fue exactamente el esperado.', review_date: '2024-05-05' },
    ],
  },
  {
    email: 'pro07@artifex7-demo.com', full_name: 'Juan Carlos López Rivas', phone: '7789-0123',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Repello de fachada exterior completa.', required_date: '2024-03-15', rating: 5, comment: 'Repelló toda mi casa con acabados increíblemente lisos. Trabajo de maestro, muy profesional.', review_date: '2024-03-25' },
      { client: 'cliente2@artifex7-demo.com', description: 'Enchape de cerámica en cocina y dos baños.', required_date: '2024-04-05', rating: 5, comment: 'Enchapó cocina y dos baños con cerámica. Trabajo muy limpio y bien medido. Excelente.', review_date: '2024-04-15' },
      { client: 'cliente3@artifex7-demo.com', description: 'Levantar pared divisoria en patio.', required_date: '2024-05-01', rating: 4, comment: 'Levantó la pared divisoria en tiempo récord. Sólida y bien terminada, recomendado.', review_date: '2024-05-10' },
    ],
  },
  {
    email: 'pro08@artifex7-demo.com', full_name: 'Ernesto Vásquez Portillo', phone: '7890-1234',
    ...
    main_category: 'albanileria',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Reparar grietas en paredes interiores.', required_date: '2024-03-20', rating: 5, comment: 'Excelente albañil, conoce muy bien el oficio. Mi patio quedó como nuevo.', review_date: '2024-03-30' },
      { client: 'cliente2@artifex7-demo.com', description: 'Enchape de patio con cerámica antideslizante.', required_date: '2024-04-10', rating: 4, comment: 'Trabajó con mucho cuidado y limpieza. Recomendado 100%, volveré a contratarlo.', review_date: '2024-04-20' },
      { client: 'cliente3@artifex7-demo.com', description: 'Fundir losa de cochera.', required_date: '2024-05-05', rating: 4, comment: 'Buen precio, cumplió el plazo acordado y dejó todo muy limpio al terminar.', review_date: '2024-05-15' },
    ],
  },
  {
    email: 'pro09@artifex7-demo.com', full_name: 'Antonio Mejía Salinas', phone: '7901-2345',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Pintar interior completo de casa de 3 habitaciones.', required_date: '2024-04-01', rating: 5, comment: 'Pintó toda mi casa interior en 3 días. Colores exactos, acabado muy limpio y profesional.', review_date: '2024-04-10' },
      { client: 'cliente2@artifex7-demo.com', description: 'Pintura exterior de fachada y barda.', required_date: '2024-04-20', rating: 5, comment: 'Excelente preparación de superficies antes de pintar. El acabado dura más que antes.', review_date: '2024-05-01' },
      { client: 'cliente3@artifex7-demo.com', description: 'Pintar local comercial interior.', required_date: '2024-05-10', rating: 4, comment: 'Mi negocio quedó como nuevo después de la pintura. Muy profesional y puntual.', review_date: '2024-05-20' },
    ],
  },
  {
    email: 'pro10@artifex7-demo.com', full_name: 'Francisco Portillo Chávez', phone: '7012-3456',
    ...
    main_category: 'pintura',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Pintura de apartamento recién construido.', required_date: '2024-04-05', rating: 5, comment: 'Puntual, ordenado y trabajó con mucho cuidado. Totalmente recomendado.', review_date: '2024-04-15' },
      { client: 'cliente2@artifex7-demo.com', description: 'Repintar habitaciones con acabado mate.', required_date: '2024-04-25', rating: 4, comment: 'Los colores quedaron uniformes y sin manchas. Muy satisfecho con el resultado.', review_date: '2024-05-05' },
      { client: 'cliente3@artifex7-demo.com', description: 'Pintura de oficina corporativa.', required_date: '2024-05-15', rating: 4, comment: 'Precio justo y resultado excelente en pintura interior y exterior.', review_date: '2024-05-25' },
    ],
  },
  {
    email: 'pro11@artifex7-demo.com', full_name: 'Luis Alberto Morales Pineda', phone: '7123-5678',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Diseñar jardín trasero desde cero.', required_date: '2024-04-10', rating: 5, comment: 'Diseñó y sembró mi jardín de cero. Quedó hermoso y muy bien organizado.', review_date: '2024-04-20' },
      { client: 'cliente2@artifex7-demo.com', description: 'Mantenimiento mensual de jardín grande.', required_date: '2024-04-30', rating: 5, comment: 'Mantiene mi jardín mensualmente con mucha dedicación. Siempre puntual y responsable.', review_date: '2024-05-10' },
      { client: 'cliente3@artifex7-demo.com', description: 'Poda de 5 árboles grandes.', required_date: '2024-05-20', rating: 4, comment: 'Podó todos mis árboles sin dañar las plantas del alrededor. Trabajo muy experto.', review_date: '2024-06-01' },
    ],
  },
  {
    email: 'pro12@artifex7-demo.com', full_name: 'Rodrigo Sánchez Henríquez', phone: '7234-6789',
    ...
    main_category: 'jardineria',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Limpieza y mantenimiento de jardín descuidado.', required_date: '2024-04-15', rating: 5, comment: 'Limpió mi jardín abandonado y lo dejó como nuevo. Muy buen trabajo y precio justo.', review_date: '2024-04-25' },
      { client: 'cliente2@artifex7-demo.com', description: 'Contrato de mantenimiento quincenal.', required_date: '2024-05-05', rating: 4, comment: 'Atendió mi jardín con mucho esmero. Lo recomendaría a cualquier persona.', review_date: '2024-05-15' },
      { client: 'cliente3@artifex7-demo.com', description: 'Podas y limpieza general de área verde.', required_date: '2024-05-25', rating: 4, comment: 'Buen servicio de mantenimiento. Mi jardín nunca había estado tan bien cuidado.', review_date: '2024-06-05' },
    ],
  },
  {
    email: 'pro13@artifex7-demo.com', full_name: 'Héctor Molina Escalón', phone: '7345-7890',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Reparar fuga de agua bajo el lavadero.', required_date: '2024-04-20', rating: 5, comment: 'Resolvió una fuga que tenía meses en minutos. Rápido, limpio y garantizó su trabajo.', review_date: '2024-05-01' },
      { client: 'cliente2@artifex7-demo.com', description: 'Instalación completa de baño nuevo.', required_date: '2024-05-10', rating: 5, comment: 'Instaló nueva tubería en mi baño completamente. Trabajo de primera calidad y limpio.', review_date: '2024-05-20' },
      { client: 'cliente3@artifex7-demo.com', description: 'Cambio de tubería de agua fría completa.', required_date: '2024-06-01', rating: 4, comment: 'Atendió emergencia de plomería un sábado por la tarde. Muy agradecido con su servicio.', review_date: '2024-06-10' },
    ],
  },
  {
    email: 'pro14@artifex7-demo.com', full_name: 'Óscar Fuentes Barrera', phone: '7456-8901',
    ...
    main_category: 'fontaneria',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Instalar nueva llave de cocina.', required_date: '2024-04-25', rating: 5, comment: 'Cambió la llave de cocina con rapidez y limpieza. Muy profesional en su trabajo.', review_date: '2024-05-05' },
      { client: 'cliente2@artifex7-demo.com', description: 'Detección de fuga en pared.', required_date: '2024-05-15', rating: 4, comment: 'Detectó y reparó una fuga oculta en la pared. Excelente trabajo diagnóstico.', review_date: '2024-05-25' },
      { client: 'cliente3@artifex7-demo.com', description: 'Reemplazar tuberías de baño principal.', required_date: '2024-06-05', rating: 4, comment: 'Buena atención, trabajo limpio y precio razonable. Lo recomiendo ampliamente.', review_date: '2024-06-15' },
    ],
  },
  {
    email: 'pro15@artifex7-demo.com', full_name: 'Rafael Zelaya Montes', phone: '7567-9012',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Instalación eléctrica completa de casa nueva.', required_date: '2024-05-01', rating: 5, comment: 'Instaló el cableado completo de mi casa nueva cumpliendo todas las normas eléctricas.', review_date: '2024-05-10' },
      { client: 'cliente2@artifex7-demo.com', description: 'Revisión y corrección de instalación defectuosa.', required_date: '2024-05-20', rating: 5, comment: 'Revisó y corrigió mi instalación eléctrica defectuosa. Trabajo muy seguro y profesional.', review_date: '2024-06-01' },
      { client: 'cliente3@artifex7-demo.com', description: 'Instalar luminarias LED en oficina.', required_date: '2024-06-10', rating: 4, comment: 'Instaló luminarias LED en toda mi oficina. El ahorro en electricidad es muy notable.', review_date: '2024-06-20' },
    ],
  },
  {
    email: 'pro16@artifex7-demo.com', full_name: 'Jesús Ramírez Bonilla', phone: '7678-0123',
    ...
    main_category: 'electricidad',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Agregar tomas y apagadores en sala.', required_date: '2024-05-05', rating: 5, comment: 'Resolvió un problema eléctrico urgente con rapidez y profesionalismo. Excelente.', review_date: '2024-05-15' },
      { client: 'cliente2@artifex7-demo.com', description: 'Reparar corto circuito en cocina.', required_date: '2024-05-25', rating: 4, comment: 'Instalación de sockets y apagadores muy ordenada y limpia. Muy recomendado.', review_date: '2024-06-05' },
      { client: 'cliente3@artifex7-demo.com', description: 'Cableado estructurado para red de datos.', required_date: '2024-06-15', rating: 4, comment: 'Muy confiable y conoce bien el oficio. Mi negocio quedó con instalación segura.', review_date: '2024-06-25' },
    ],
  },
  {
    email: 'pro17@artifex7-demo.com', full_name: 'Víctor Argueta Mejía', phone: '7789-1234',
    ...
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Techo metálico a dos aguas para bodega.', required_date: '2024-05-10', rating: 5, comment: 'Fabricó e instaló el techo de mi bodega. Estructura sólida, bien soldada y duradera.', review_date: '2024-05-20' },
      { client: 'cliente2@artifex7-demo.com', description: 'Portón eléctrico corredizo para residencia.', required_date: '2024-05-30', rating: 5, comment: 'Instaló portón eléctrico en mi casa. Muy duradero, seguro y con garantía incluida.', review_date: '2024-06-10' },
      { client: 'cliente3@artifex7-demo.com', description: 'Rejas de seguridad para ventanas.', required_date: '2024-06-20', rating: 4, comment: 'Rejas de seguridad para mis ventanas. Trabajo fino, limpio y bien terminado.', review_date: '2024-07-01' },
    ],
  },
  {
    email: 'pro18@artifex7-demo.com', full_name: 'Marco Antonio Guzmán Peña', phone: '7890-2345',
    ...
    main_category: 'estructura-metalica',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Pérgola metálica para terraza.', required_date: '2024-05-15', rating: 5, comment: 'Construyó una pérgola preciosa en mi terraza. Muy sólida y con excelente acabado.', review_date: '2024-05-25' },
      { client: 'cliente2@artifex7-demo.com', description: 'Canceles metálicos para cochera doble.', required_date: '2024-06-05', rating: 4, comment: 'Rejas y canceles en toda mi casa. Trabajo preciso y de buena calidad estructural.', review_date: '2024-06-15' },
      { client: 'cliente3@artifex7-demo.com', description: 'Techo metálico para cochera.', required_date: '2024-06-25', rating: 4, comment: 'Muy profesional con la soldadura. Mi cochera quedó con techo metálico excelente.', review_date: '2024-07-05' },
    ],
  },
  {
    email: 'pro19@artifex7-demo.com', full_name: 'Alejandro Reyes Castellanos', phone: '7901-3456',
    ...
    main_category: 'pisos',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Instalar porcelanato en sala, comedor y pasillos.', required_date: '2024-05-20', rating: 5, comment: 'Instaló porcelanato en toda la planta baja de mi casa. Acabado perfecto, sin una fisura.', review_date: '2024-06-01' },
      { client: 'cliente2@artifex7-demo.com', description: 'Piso vínico para oficina de 80m².', required_date: '2024-06-10', rating: 5, comment: 'Colocó piso vínico en mi oficina en un día. Quedó muy moderno y muy profesional.', review_date: '2024-06-20' },
      { client: 'cliente3@artifex7-demo.com', description: 'Levantar piso viejo y poner cerámica nueva.', required_date: '2024-07-01', rating: 4, comment: 'Levantó el piso viejo y puso cerámica nueva en cocina y baños. Excelente resultado.', review_date: '2024-07-10' },
    ],
  },
  {
    email: 'pro20@artifex7-demo.com', full_name: 'Diego Chávez Hernández', phone: '7012-4567',
    ...
    main_category: 'pisos',
    reviews: [
      { client: 'cliente1@artifex7-demo.com', description: 'Instalar cerámica en 3 habitaciones.', required_date: '2024-05-25', rating: 5, comment: 'Instaló cerámica en mis 3 habitaciones. Trabajo rápido, limpio y de mucha calidad.', review_date: '2024-06-05' },
      { client: 'cliente2@artifex7-demo.com', description: 'Porcelanato en planta baja completa.', required_date: '2024-06-15', rating: 4, comment: 'Muy bien medido y cortado, sin desperdicios. El porcelanato quedó perfecto.', review_date: '2024-06-25' },
      { client: 'cliente3@artifex7-demo.com', description: 'Piso para local comercial 120m².', required_date: '2024-07-05', rating: 4, comment: 'Buena experiencia, precio justo y resultado hermoso en el piso de mi local.', review_date: '2024-07-15' },
    ],
  },
]
...
async function cleanDemo() {
  ...
  const { data: profiles } = await supabase
    ...
    .in('id', (await supabase.auth.admin.listUsers({ perPage: 1000 }))
      .data?.users?.filter(u => u.email?.endsWith('@artifex7-demo.com'))
      .map(u => u.id) ?? [])
...
async function main() {
  ...
  log('\n══════════════════════════════════════════════')
  log('  Artifex7 — Creación de datos de demostración')
  log('══════════════════════════════════════════════')
  ...
  const testEmail = `test-diag-${Date.now()}@artifex7-demo.com`
